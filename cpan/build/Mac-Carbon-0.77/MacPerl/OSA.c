...
#line 105 "OSA.c"
XS(XS_MacPerl_Reply); /* prototype to pass -Wmissing-prototypes */
XS(XS_MacPerl_Reply)
{
    dXSARGS;
    if (items != 1)
    ...
    {
	char *	reply = (char *)SvPV_nolen(ST(0));
#line 101 "OSA.xs"
	{
#ifndef MACOS_TRADITIONAL
...
XS(XS_MacPerl_DoAppleScript); /* prototype to pass -Wmissing-prototypes */
...
extern "C"
#endif
XS(boot_OSA); /* prototype to pass -Wmissing-prototypes */
XS(boot_OSA)
{
    dXSARGS;
    char* file = __FILE__;
