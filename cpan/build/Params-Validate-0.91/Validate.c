...
#line 1537 "Validate.c"

XS(XS_Params__Validate__validate); /* prototype to pass -Wmissing-prototypes */
XS(XS_Params__Validate__validate)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: Params::Validate::_validate(p, specs)");
    SP -= items;
    {
	SV*	p = ST(0);
	SV*	specs = ST(1);
#line 1541 "Validate.xs"
    HV* ret = NULL;
    AV* pa;
    HV* ph;
    HV* options;
...
XS(XS_Params__Validate__validate_pos); /* prototype to pass -Wmissing-prototypes */
XS(XS_Params__Validate__validate_pos)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: Params::Validate::_validate_pos(p, ...)");
    SP -= items;
    {
	SV*	p = ST(0);
#line 1603 "Validate.xs"
    AV* specs;
    AV* ret = NULL;
    IV i;
...
XS(XS_Params__Validate__validate_with); /* prototype to pass -Wmissing-prototypes */
XS(XS_Params__Validate__validate_with)
{
    dXSARGS;
   PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
#line 1640 "Validate.xs"
    HV* p;
    SV* params;
    SV* spec;
    IV i;
...
extern "C"
#endif
XS(boot_Params__Validate); /* prototype to pass -Wmissing-prototypes */
XS(boot_Params__Validate)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Params::Validate::_validate", XS_Params__Validate__validate, file, "\\@$");
        newXSproto("Params::Validate::_validate_pos", XS_Params__Validate__validate_pos, file, "\\@@");
        newXS("Params::Validate::_validate_with", XS_Params__Validate__validate_with, file);

    /* Initialisation Section */

#line 1530 "Validate.xs"
  bootinit();

#line 1788 "Validate.c"
